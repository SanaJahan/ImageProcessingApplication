...
public class ImageReader {
  ...
  public static void main(String[] args) throws IOException {
    //read the file
    File f = new File("images/manhattan-small.png");
    ...
    //write the file
    writeImage("images/blur.png", blur.applyBlurringEffect(), image.getWidth(), image.getHeight());

    //create the sharpen effect
    ISharpen sharpen = new SharpenImage(img, image.getHeight(), image.getWidth());
    writeImage("images/sharpen.png", sharpen.applySharpeningEffect(), image.getWidth(), image.getHeight());

    //create the grey scale effect
    GreyScale greyScale = new GreyScale(img, image.getHeight(), image.getWidth());
    writeImage("images/greyscale.png", greyScale.applyColorTransformation(), image.getWidth(), image.getHeight());

    //create the sepiatone effect
    SepiaTone sepiaTone = new SepiaTone(img, image.getHeight(), image.getWidth());
    writeImage("images/sepiatone.png", sepiaTone.applyColorTransformation(), image.getWidth(), image.getHeight());


    // generate the checker board
    IGenerateCheckerBoard generateImage = new GenerateCheckerBoard(40);
    writeImage("images/checkerboard.png", generateImage.generateCheckerBoard(),
    ...
    writeImage("images/horizontal.png", vibgyorHorizontalStripes.createHorizontalVIBGYOR(), vibgyorHorizontalStripes.getWidth(),vibgyorHorizontalStripes.getHeight());

    //generate vibgyor vertical
    GenerateVibgyorStripes vibgyorVerticalStripes = new GenerateVibgyorStripes(500,400);
    writeImage("images/vertical.png", vibgyorVerticalStripes.createVerticalVIBGYOR(), vibgyorVerticalStripes.getWidth(),vibgyorVerticalStripes.getHeight());
